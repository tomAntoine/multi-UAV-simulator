...
class Trajectory:
    ...
    def __init__(self, psi, ctrlType, trajSelect,
        pos_ini=[0,0,0], pos_goal=[20,20,20],pos_obs = None,Tf=18,t_ini=0):
        ...
        self.wps_pf3d, data = pf3d(pos_ini, pos_goal, pos_obs)
        self.data = data
        self.wps = makeWaypoints(self.wps_pf3d,t_ini = t_ini,Tf=Tf)


# guidance algos to generate the command

        t_wps, wps, y_wps, v_wp = self.wps
        self.wps = wps
        self.t_wps = t_wps
        self.y_wps = y_wps
        self.v_wp  = v_wp
    ...
    def desiredState(self, t, Ts, pos):
